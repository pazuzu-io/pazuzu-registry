...
//    public static Feature asDto(io.pazuzu.registry.domain.Feature feature) {
//        return asDto(feature, FeatureFields.ALL);
//    }
//
//    public static Feature asDto(io.pazuzu.registry.domain.Feature feature, FeatureFields featureFields) {
...
//    }
//
//    public static Review asReviewDto(io.pazuzu.registry.domain.Feature feature) {
...
//    }
//
//    public static FeatureMeta asMetaDto(io.pazuzu.registry.domain.Feature feature) {
...
//                        io.pazuzu.registry.domain.Feature::getName).collect(Collectors.toList()));
//        return dto;
//    }
//
//    /**
...
//     */
//    public static Function<io.pazuzu.registry.domain.Feature, Feature> forFields(FeatureFields featureFields) {
